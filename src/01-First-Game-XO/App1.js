...
import OneSelection from './components/Button';
import Field from './components/Field';
import ResetParty from './components/ResetParty';
import Player from './components/Player';
import FirsWindow from './components/FirstWindow';
...
function App1() {
  ...
  return (
      ...
      <Field>
        ...
        {/*<OneSelection player={table[3]} onClick={(e) => {
          changePlayer()
          setTable({ ...table, 3: player })
        }
        } />
        <OneSelection player={player} onClick={changePlayer} id={2} /> */}
      </Field>
